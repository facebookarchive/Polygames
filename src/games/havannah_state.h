...
template <int SIZE, bool PIE, bool EXTENDED> Havannah::State<SIZE, PIE, EXTENDED>::State(int seed) : core::State(seed) {
  Initialize();
}
...
template <int SIZE, bool PIE, bool EXTENDED>
std::unique_ptr<core::State> Havannah::State<SIZE, PIE, EXTENDED>::clone_() const {
...
template <int SIZE, bool PIE, bool EXTENDED>
int Havannah::State<SIZE, PIE, EXTENDED>::parseAction(const std::string& str) const {
